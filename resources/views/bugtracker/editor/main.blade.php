...
<a href="{{ route('project.boards', compact('project')) }}" class="btn btn-default return-to-boards editor-controls"><span class="glyphicon glyphicon-triangle-left"></span><span class="glyphicon glyphicon-blackboard"></span> @lang('editor.return_to_boards')</a>
