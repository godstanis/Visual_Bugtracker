                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">@lang('auth.password_confirm')</label>
                    ...
                    <div class="text-center">
                        <span class="text-muted "><small>@lang('auth.site_uses_cookies')</small></span>
                    </div>
                </div>
            </div>
        </div>
